...
const STOCK_NARRATIVE_DEMO: Record<string, string> = {
  "000660": "HBM 수급과 실적 기대가 주중 내내 반복 언급되며 최상위 화제였어요. 주말 들어 언급은 빠르게 식는 흐름이에요.",
  "005930": "미국 ADR 상장 검토 소식이 확산되며 언급이 튀었고, 파운드리 회복 기대가 뒤따라 붙었어요.",
  "034730": "지주사 밸류업과 자회사 지분 이슈가 반복 등장했지만, 언급량 자체는 크지 않았어요.",
};
