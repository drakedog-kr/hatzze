 ...
 *
 * ⚠️⚠️ `alignItems` 를 주지 않는다(기본값 stretch). 다만 **늘려서 바닥을 맞추려면 두
 * 카드의 자연 높이가 애초에 비슷해야 한다.** 벌어진 만큼이 그대로 짧은 카드 안의 흰
 * 구멍이 되기 때문이다 — 분기 두 장이 292 대 392 이던 시절엔 기관 몫 안에 78px 짜리
 * 구멍이 생겼다. 지금은 두 줄 다 손으로 맞춰 뒀다.
 *
 *   ETF     572 대 572   (주간 등락의 본문 각주 한 줄을 시트 각주로 내려 맞췄다)
 *   분기    448 대 451   (기관 몫에 신고자 목록을 넣고, 곡선 높이를 185 로 잡아 맞췄다)
 *
 * ⚠️ 그래서 이 두 줄은 **한쪽의 줄 수가 바뀌면 반대쪽도 다시 재야 한다.**
 */
