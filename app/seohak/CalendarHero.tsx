  ...
  return (
    <section className="hz-sheet">
      <SectionHead level={2}
        ...
        title="서학개미의 1년"
        /* ⚠️ 부제는 **명사구**로 끝낸다. 다른 화면(카더라·MDD)의 부제가 전부 그렇다.
           ⚠️ "…사고파는 건수는 늘 그대로고 달라지는 건 한 번에 넣는 금액" 이었다. 그건
           부제가 아니라 **발견**이고, 부제 자리에서 세 줄을 먹었다. 부제는 이 카드가
           무엇을 담는지만 말한다 — 발견은 카드 안 줄들이 스스로 보여 준다. */
        desc="하루하루의 순매수와 해마다 되풀이되는 때"
        note={`${md(c.asOf)} 기준`}
