 ...
 *
 * 엠파이어 스테이트: 처음엔 같은 방법으로 떴는데 손그림 선의 울퉁불퉁함까지 따라와, 뜬 것을 자로 삼아 직선으로 다시 그렸다(UsEmpireIcon 주석).
 *
...
/**
 * 엠파이어 스테이트 상층부 — potrace 로 뜬 것은 참고의 손그림 선이 그대로 울퉁불퉁해서("건곤감리처럼 깔끔하게"), 뜬 것을 자로
 * 삼아 **직사각형으로 다시 그렸다**: 안테나(끝이 뾰족한 막대) · 고리 셋 · 첨탑(사다리꼴 테두리 + 안쪽 세로줄 둘) · 관 기단 슬래브 넷
 * (둘째는 속 빈 상자) · 빗살 여덟의 윗단 · 몸통(양 벽 + 세로줄 다섯, 아래는 열림) · 날개 두 단(안쪽 세로줄 둘·하나). 획 10(참고 실측 9~10).
 * 좌표는 참고 이미지(1024) 그대로 재서 쓰고 transform 이 24 박스로 옮긴다. 오른쪽은 왼쪽의 거울이다(참고는 오른쪽이 어긋나 있다).
 * 만든 스크립트: 저장소 밖 hatzze-icons/trace/esb_clean.py — 손으로 좌표를 고치지 말고 거기서 다시 뽑을 것.
 */
function UsEmpireIcon({ size = 20 }: { size?: number }) {
  ...
  return (
    <svg width={draw} height={draw} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style={{ display: "block", flexShrink: 0, margin: -pull }}>
      <g transform="translate(-7.761 -7.568) scale(0.03860)">
        <path d="M512 222 L517 240 L517 372 L507 372 L507 240 Z M498 372 L526 372 L526 382 L498 382 Z M498 381 L526 381 L526 391 L498 391 Z M498 372 L508 372 L508 391 L498 391 Z M516 372 L526 372 L526 391 L516 391 Z M493 391 L531 391 L531 401 L493 401 Z M493 400 L531 400 L531 410 L493 410 Z M493 391 L503 391 L503 410 L493 410 Z M521 391 L531 391 L531 410 L521 410 Z M489 410 L535 410 L535 420 L489 420 Z M489 414 L535 414 L535 424 L489 424 Z M489 410 L499 410 L499 424 L489 424 Z M525 410 L535 410 L535 424 L525 424 Z M492 424 L502 424 L488 522 L478 522 Z M522 424 L532 424 L546 522 L536 522 Z M500.5 428 L510.5 428 L508.5 522 L498.5 522 Z M513.5 428 L523.5 428 L525.5 522 L515.5 522 Z M471 522 L553 522 L553 534 L471 534 Z M462 536 L562 536 L562 546 L462 546 Z M462 543 L562 543 L562 553 L462 553 Z M462 536 L472 536 L472 553 L462 553 Z M552 536 L562 536 L562 553 L552 553 Z M449 553 L575 553 L575 565 L449 565 Z M440 567 L584 567 L584 579 L440 579 Z M440 596 L584 596 L584 606 L440 606 Z M440 579 L450 579 L450 606 L440 606 Z M574 579 L584 579 L584 606 L574 606 Z M458.8 579 L468.8 579 L468.8 606 L458.8 606 Z M472.6 579 L482.6 579 L482.6 606 L472.6 606 Z M486.3 579 L496.3 579 L496.3 606 L486.3 606 Z M500.1 579 L510.1 579 L510.1 606 L500.1 606 Z M513.9 579 L523.9 579 L523.9 606 L513.9 606 Z M527.7 579 L537.7 579 L537.7 606 L527.7 606 Z M541.4 579 L551.4 579 L551.4 606 L541.4 606 Z M555.2 579 L565.2 579 L565.2 606 L555.2 606 Z M474 606 L484 606 L484 792 L474 792 Z M540 606 L550 606 L550 792 L540 792 Z M488.3 618 L498.3 618 L498.3 792 L488.3 792 Z M497.7 618 L507.7 618 L507.7 792 L497.7 792 Z M507 618 L517 618 L517 792 L507 792 Z M516.3 618 L526.3 618 L526.3 792 L516.3 792 Z M525.7 618 L535.7 618 L535.7 792 L525.7 792 Z M430 606 L474 606 L474 616 L430 616 Z M550 606 L594 606 L594 616 L550 616 Z M430 606 L440 606 L440 792 L430 792 Z M584 606 L594 606 L594 792 L584 792 Z M446.3 620 L456.3 620 L456.3 792 L446.3 792 Z M457.7 620 L467.7 620 L467.7 792 L457.7 792 Z M567.7 620 L577.7 620 L577.7 792 L567.7 792 Z M556.3 620 L566.3 620 L566.3 792 L556.3 792 Z M400 644 L430 644 L430 654 L400 654 Z M594 644 L624 644 L624 654 L594 654 Z M400 644 L410 644 L410 792 L400 792 Z M614 644 L624 644 L624 792 L614 792 Z M415 658 L425 658 L425 792 L415 792 Z M599 658 L609 658 L609 792 L599 792 Z" />
      </g>
    </svg>
  );
}
