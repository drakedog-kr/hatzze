...
부른다. 함께 손본 것 둘(2026-09-10, 같은 PR):
  ...
  · **토요일 글이 쓰는 미장 까닭은 발송 직전에 만든다**(telegram-broadcast.yml 의
    us_move_reasons 스텝). 그 표의 토요일 행은 원래 저녁 실행(18:00)에서 생겨 10:30 글이
    못 썼다. ⚠️ 생성기가 한때 그날 글 수(1,500건)로 아침을 짐작해 그 스텝이 09-12·19·26
    세 번 다 건너뛰었다(그 시각 DB 엔 120~190건). 지금은 `--slot morning` 일 때만 안 만든다.
