...
INDICATOR_THRESHOLDS = {
    ...
    #
    # ±50%: 평균이면 상온(50) · 평균 대비 +50%면 초고온(100). 1,114일 실측으로
    # 천장 포화 8.3%(put_call 5% 언저리) · 바닥 포화 0.5% 라 양쪽 다 안 뭉개진다.
    # ±30%는 천장이 17.8%로 헐겁고, ±60%는 바닥이 0%가 되어 아래쪽 정보를 잃는다.
    #
    # ⚠️ **이 지표는 과열보다 변동성에 가깝다.** 국면별 실측 중앙: 하락장 45.1 · 평범 46.3
    # · 강세 45.4 · 회복 56.2 · **2026 폭락 90.6**. 급등 종목은 시장이 어느 쪽으로든 크게
    ...
    "limit_up_breadth": {"kind": "rolling_average", "window": 252, "surge_map": {"floor": -50.0, "ceil": 50.0}},
