...
SPEED_META = {
    ...
    "category": "시장",
    # "천천히 오른 것과 급하게 온 것은 다릅니다" 였다(~2026-08-04). 맞는 말이지만 둘을
    # 견주기만 하고 **어느 쪽이 과열인지를 안 말해서**, 카드의 큰 수치가 +인지 -인지에
    # 따라 읽는 사람이 뜻을 반대로 가져갈 수 있었다. 다른 카드들과 같은 "X할수록 Y" 꼴로
    # 방향을 못박는다.
    "description_beginner": (
        "급하게 오를수록 시장이 달아올랐다는 뜻입니다"
    ),
    "unit": "%",
}
