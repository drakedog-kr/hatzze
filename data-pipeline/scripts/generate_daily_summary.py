...
# 2026-09-23 Haiku → Opus 5.5. 사이트 첫 화면 맨 위 글이다. 하루 두 번 돌고 한 번에 세 대목을
# 쓴다. Opus 는 저절로 쓰는 문장이 Haiku 보다 길어 세 대목의 *_LEN 상한을 모두
# 내렸다(그 주석). 그 대가로 다시 쓰기가 늘어 한 번에 호출이 7~9번이다(Haiku 3~5번).
# 같은 재료 4회 266자(그날 실제로 나간 Haiku 글 253자, 프로덕션 3주 평균 245자).
