...
# 국내는 10줄인데 미장은 12줄이다. 이 카드가 **반칸 시트**라 줄 수가 곧 조판 손잡이다 —
# 옆에 나란히 서는 생태계 센티먼트(일별 14줄, 712px)와 높이를 맞춘다(12줄 = 718px).
...
# ⚠️ lib/us-telegram-data.ts 의 US_SENTIMENT_SERIES_DAYS(14) 와 짝이다. 한쪽만 고치지 말 것.
ISSUE_KEYWORD_LIMIT = 12
