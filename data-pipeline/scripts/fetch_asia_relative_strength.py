...
INDICATOR_META = {
    ...
    "category": "정통",
    "description_beginner": "최근 한 달간 코스피가 일본·홍콩·대만 증시보다 얼마나 더 올랐는지 보여줘요. 한국만 유독 앞서가고 있다면 그만큼 쏠림이 심하다는 뜻일 수 있어요",
    "unit": "%p",
    # kospi_volume_surge/vkospi와 비슷한 급의 보조-정통 지표라 기본값(1)보다
