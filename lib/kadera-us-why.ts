 ...
 *
 * 한때 사흘(BOARD_STALE_DAYS)에서 잘랐는데, 2026-09-24~26 추석에 파이프라인이 미장 판을 안
 * 만들어(연휴 저녁 글 수를 아침 실행으로 오인했다 · generate_move_reasons.py 머리 주석) 그 사흘을
 * 넘겨 09-27 에 카드가 통째로 비었다(마지막 판 09-23). 파이프라인이 멈춘 날에도 빈 카드보다
