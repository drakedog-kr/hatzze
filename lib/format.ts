 ...
 *
 * 2026-08-14 실측으로 고른 값이다. 두 슬롯의 완료 분포는 이렇다:
 *
 *   아침(발화 06:30)  큐 지연 31~62분 + 소요 74~95분  → 완료 08:20~09:10, 중심 08:40
 *   오후(발화 17:30)  큐 지연 64~69분 + 소요 87~104분 → 완료 19:55~20:25, 중심 20:10
 *
 * 그래서 **아침 9시 · 오후 8시**다. 중심에서 아침은 20분 앞서고 오후는 10분 앞선다.
 * (아침을 8시로 두면 40분 뒤처지고, 오후를 9시로 두면 50분 앞선다 — 둘 다 더 멀다.)
 *
