 ...
 *   18:00 시작 → 디시 표본 17:16~19:16 → 19:23 완료
 * ⚠️ 디시 표본은 **지금과 9분 차**다(예약이 평균 18:09 에 시작해 17:25~19:25 였다).
 *    눈금(17:45~20:00 표본으로 재보정)에서 벗어난 건 지금도 마찬가지고, 그 폭이 9분
 *    더 벌어진다. 눈금을 다시 잡을 일이 생기면 이 값부터 확인할 것.
