...
같은 워크플로 끝에서 [채널](https://t.me/hatzze69)에 그날의 글을 올립니다. 네 가지가 소재로 갈립니다 (아침=주제·사건 · 저녁=종목 · 테마=관심 이동 · 주간=생태계).

| | 언제 | 내용 |
|---|---|---|
| A 어제 브리핑 | 월~금 아침 | 어제 이슈 키워드 + 밤사이 오간 이야기 |
| B 마감 리포트 | 월~금 저녁 | 오늘의 온도 + 카더라 급부상 종목 3 |
| C 관심 이동 | 화·금 저녁 | 테마 순위 변동 + 무엇이 달라졌나 |
| D 주간 결산 | 일요일 저녁 | 주간 최다 언급 종목 + 테마 |
