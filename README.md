...
| 발사(KST) | 워크플로 | 하는 일 |
|---|---|---|
| 07:00 | `daily-update` | 지표·카더라 갱신 → 완료 ~08:27, 평일이면 개장 전 요약 |
...
| | 언제 | 내용 |
|---|---|---|
| 🌅 개장 전 요약 | 월~금 · 오전 파이프라인 후 | 밤사이(18~08시) 이야기 3~4개 + 오늘 일정 |
| 🌆 저녁 브리핑 | 월~금 · 오후 파이프라인 후 | 온도 + 오늘 이야기 3~4개(어떤 종목이 왜 움직였나) + 처음 회자된 종목 + 내일 일정 |
