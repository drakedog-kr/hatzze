...
`daily-update.yml`이 매일 두 번 파이프라인을 돌립니다.

| cron 발화 | 실제 실행 | 화면 표기 | 역할 |
|---|---|---|---|
| 06:30 KST | ~07:30 | 오전 9시 | 주 실행 |
| 17:30 KST | ~18:40 | 오후 8시 | 아침 실패 만회 + 그날 종가 |

**발화 시각은 실제 실행 시각이 아닙니다.** 깃헙 예약 큐가 실행을 한 시간쯤 밀어냅니다. 그래서 발화를 이르게 잡고 잡 안의 대기 게이트로 08:00 KST를 못 박습니다.
